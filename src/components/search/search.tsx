    ...
    <div class="relative w-full max-w-md">
      ...
      >
        <input
          ...
          class="text-main-foreground border-border shadow-shadow w-full min-w-0 border-2 bg-white p-2 text-sm outline-none focus:ring-2 focus:ring-blue-400 sm:text-base"
          onFocus$={() => {
